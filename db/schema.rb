...
ActiveRecord::Schema[7.0].define(version: 2022_06_21_124109) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["AuthorId_id"], name: "index_comments_on_AuthorId_id"
  ...
  add_foreign_key "comments", "users", column: "AuthorId_id"
